...
const ModalUpdateDocumentConductor = ({ open, onClose, documento, onSave }: ModalProps) => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await axios.post(`update_documento_conductor`, data);
...
export { ModalUpdateDocumentConductor };
