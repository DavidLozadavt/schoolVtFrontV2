...
import { User, MapPin, Phone, Mail, Package, X, AlertTriangle } from 'lucide-react';
...
interface VerPedidoPendiProps {
  open: boolean;
  pedido: Pedido | null;
  onClose: () => void;
}

const VerPedidoPendi: React.FC<VerPedidoPendiProps> = ({ open, pedido, onClose }) => {
