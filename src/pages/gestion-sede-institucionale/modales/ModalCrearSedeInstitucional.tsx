...
interface ModalCrearSedeInstitucionalProps {
  open: boolean;
  onClose: () => void;
  onSave?: () => void;
}

const ModalCrearSedeInstitucional: React.FC<ModalCrearSedeInstitucionalProps> = ({
  open,
  onClose,
  onSave
}) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await axios.post('/sedes-institucionales', data);
...
export default ModalCrearSedeInstitucional;
