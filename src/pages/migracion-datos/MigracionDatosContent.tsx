...
const ENTIDADES: {
...
}[] = [
  {
    ...
    nombre: 'Trabajadores',
    color: 'blue-700',
    img: '/media/images/Trabajadores.png',
    headers: [
      'nombre1',
      'nombre2',
      'apellido1',
  ...
  },
  {
    ...
    nombre: 'Estudiantes',
    color: 'green-700',
    img: '/media/images/Estudiantes.png',
    headers: [
      'nombre1',
      'nombre2',
      'apellido1',
  ...
  },
  {
    ...
    nombre: 'Productos',
    color: 'orange-600',
    img: '/media/images/Productos.png',
  ...
  },
  {
    ...
    color: 'purple-700',
    img: '/media/images/Infraestructura.png',
    ...
    <Container>
      ...
      <div className="flex flex-col sm:flex-row justify-center gap-6">
        {ENTIDADES.map((e) => (
          <div
            key={e.key}
            className="group relative w-full max-w-sm border-neutral-200 dark:border-neutral-700 bg-neutral-100 dark:bg-neutral-900 rounded-2xl shadow-lg overflow-hidden"
          >
