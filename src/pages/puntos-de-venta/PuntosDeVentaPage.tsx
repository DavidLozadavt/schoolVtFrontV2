...
import { PuntoVenta } from './models/TypesInterface';
...
const PuntosDeVentaPage = () => {
  ...
  const handleModalOpenBox = () => setModalOpenBox(true);
  const handleModalCloseBox = () => setModalOpenBox(false);
    ...
    <div className="card max-w-6xl mx-auto my-6">
      <div className="card-header">
        <h3 className="card-title flex items-center gap-2">
          {/* <KeenIcon icon="shop" className="text-primary text-xl" /> */}
          Puntos de Venta
        </h3>
      </div>
        ...
        <div className="flex justify-center mb-6">
          <div className="w-full md:w-1/2 lg:w-1/3">
            <label className="form-label flex items-center gap-2">
              {/* <KeenIcon icon="geolocation" className="text-gray-600" /> */}
              {/* Seleccionar Sede */}
            </label>
            <select
                    ...
                    {isOpen && punto.cajas[0]?.usuario?.persona ? (
                      <div className="text-center mb-4">
                        ...
                        {/* <p className="text-xs text-gray-400 mt-1 flex items-center justify-center gap-1">
                                                    <KeenIcon icon="dollar" className="text-xs" />
                                                    ${parseFloat(punto.cajas[0].valorEfectivo).toLocaleString('es-CO')}
                                                </p> */}
                      </div>
                    ) : (
