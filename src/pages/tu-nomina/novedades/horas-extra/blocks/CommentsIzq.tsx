...
const CommentsIzq = ({ text, time, avatar }: IDropdownChatMessageInProps) => {
  return (
    <div className="flex items-end gap-3.5 px-5">
      <img src={avatar} className="rounded-full mb-5 size-9" alt="" />
...
export { CommentsIzq, type IDropdownChatMessageInProps };
